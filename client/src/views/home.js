  ...
  return (
    <div className="home-container">
      ...
      <div className="home-header">
        ...
        >
          <span className="logo">STOMATA</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            <h1 className="home-hero-heading heading1">
              Detect Stomata with Precision
            </h1>
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Stomata Detection Tool</span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <h2 className="home-features-heading heading2">
                Advanced Stomata Detection Features
              </h2>
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>Unlock the power of our cutting-edge technology</span>
                    <span>
                      <span
                        dangerouslySetInnerHTML={{
                          __html: ' ',
            ...
            <div className="home-container03">
              <FeatureCard
                heading="Stomata Detection"
                subHeading="Accurately detects stomata from microscopic images and videos of leaves"
              ></FeatureCard>
              <FeatureCard
                heading="Photo and Video Support"
                subHeading="Works with both photo and video formats for stomata detection"
              ></FeatureCard>
              <FeatureCard
                heading="JSON Output"
                subHeading="Provides JSON output for easy integration with other applications"
              ></FeatureCard>
              <FeatureCard
                heading="High Accuracy"
                subHeading="Delivers precise results with advanced algorithms and machine learning"
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>
                  Unlock the full potential of stomata detection with our
          ...
          <div className="home-container05">
            <div className="freePricingCard home-pricing-card">
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">Stomata detection in photos</span>
                </div>
                <div className="home-container10">
                  <span className="home-text41">✔</span>
                  <span className="bodySmall">Limited video analysis</span>
                </div>
                <div className="home-container11">
                  <span className="home-text42">✔</span>
                  <span className="bodySmall">Basic data visualization</span>
                </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              ...
              <div className="home-container14">
                ...
                <span className="home-basic-plan-pricing">19.99</span>
              ...
              <div className="home-container15">
                ...
                <div className="home-container17">
                  ...
                  <span className="bodySmall">
                    Stomata detection in photos and videos
                  </span>
                </div>
                <div className="home-container18">
                  <span className="home-text52">✔</span>
                  <span className="bodySmall">Advanced video analysis</span>
                </div>
                <div className="home-container19">
                  <span className="home-text53">✔</span>
                  <span className="bodySmall">Detailed data visualization</span>
                </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              ...
              <div className="home-container22">
                ...
                <span className="home-pro-plan-pricing">49.99</span>
              ...
              <div className="home-container23">
                ...
                <div className="home-container26">
                  ...
                  <span className="bodySmall">
                    Advanced video analysis with AI algorithms
                  </span>
                </div>
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
          <h1 className="home-banner-heading heading2">
            Revolutionary Stomata Detection Technology
          </h1>
            ...
            <span>
              <span>
                <span>
                  ...
                  technology, you can easily analyze stomatal density, size, and
                  distribution for your research or agricultural needs.
                </span>
                <span>
                  <span
                    dangerouslySetInnerHTML={{
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="Stomata are small openings on the surface of leaves that allow for the exchange of gases, such as oxygen and carbon dioxide, between the plant and its environment."
                question="What is stomata?"
              ></Question1>
              <Question1
                answer="Detecting stomata can provide valuable insights into a plant's physiological processes, such as photosynthesis and transpiration. It can also help in studying plant responses to environmental factors and diseases."
                question="Why is it important to detect stomata?"
              ></Question1>
              <Question1
                answer="The stomata detection process involves analyzing the microscopic view of a leaf, either in photo or video format, using advanced image processing techniques. These techniques identify and locate the stomata on the leaf surface."
                question="How does the stomata detection process work?"
              ></Question1>
              <Question1
                answer="Yes, our stomata detection system is capable of analyzing both photos and videos of leaf samples to detect and quantify stomata."
                question="Can stomata detection be performed on both photos and videos?"
              ></Question1>
              <Question1
                answer="Stomata detection can be used in various fields such as plant physiology research, agriculture, environmental monitoring, and crop breeding programs to assess plant health, water-use efficiency, and response to different environmental conditions."
                question="What are the potential applications of stomata detection?"
              ></Question1>
            </div>
          </div>
        </div>
