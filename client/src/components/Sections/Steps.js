            ...
            <div className="mx-6 py-8 px-7 w-fit bg-sgreen-100 rounded-2xl flex flex-col justify-center items-center">
                ...
                <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7">
                    <div className="bg-white max-w-80 py-8 px-6 rounded-2xl">
                        ...
                        <p className="text-base font-light tracking-wider text-gray-700">At first, create an account on our website by using your email address</p>
                    </div>
                    <div className="bg-white max-w-80 py-8 px-6 rounded-2xl">
                        ...
                        <p className="text-base font-light tracking-wider text-gray-700">Upload an image or video from which you want to detect stomata</p>
                    </div>
                    <div className="bg-white max-w-80 py-8 px-6 rounded-2xl">
                        ...
                        <p className="text-base font-light tracking-wider text-gray-700">Our advance algorithm will detect stomata from your images or videos</p>
                    </div>
                </div>
            </div>
        </section>
