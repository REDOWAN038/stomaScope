...
const HeroSection = () => {
    return (
        <section className="flex flex-col md:flex-row-reverse justify-center md:justify-between items-center my-2 lg:w-large lg:mx-auto md:mt-20 lg:mt-32" id="home">
