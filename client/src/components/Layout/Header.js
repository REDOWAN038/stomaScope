            ...
            <nav className="w-full flex justify-between items-center px-9 lg:w-large text-xs">
                ...
                <div className='flex gap-10'>
                    <ul className='md:flex gap-3 hidden'>
                        <li><button className="bg-sgreen-100 border-2 border-sgreen-100 text-xs text-white px-3 py-1 rounded-full ">Sign In</button></li>
                        <li><button className="bg-white border-2 border-black text-xs text-black px-3 py-1 rounded-full">Sign Up</button></li>
                    </ul>
                </div>
